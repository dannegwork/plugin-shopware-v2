...
class BxIndexConfig{
    ...
    /**
     * \Boxalino\Helper\BxIndexConfig constructor.
     */
    public function __construct()
    {
//        $this->plugin = new \Boxalino\Boxalino();
        $this->db = Shopware()->Db();
        $this->init();
    }
...
//        $pluginConfig = Shopware()->Container()->get('shopware.plugin.cached_config_reader')->getByPluginName($this->plugin->getName(), $id);
