...
class BxChooseResponse
{
    ...
    public function getCPOJourney($choice_id = 'NarrativeRenderer') {
    ...
    public function getStoryLine($choice_id = 'NarrativeRenderer') {
    ...
    public function getNarrativeDependencies($choice_id = 'NarrativeRenderer') {
        $dependencies = array();
    ...
    public function getNarratives($choice_id = 'NarrativeRenderer') {
        ...
        if(isset($storyLine['groupedNarratives'])) {
            foreach ($storyLine['groupedNarratives'] as $groupedNarrative) {
                if(isset($groupedNarrative['narratives'])) {
                    ...
                    if(isset($narratives['NarrativeRenderer']) && isset($narratives['NarrativeRenderer']['acts'])) {
                        $narrativesParameters = isset($narratives['parameters']) ? $narratives['parameters'] : [];
                        $narrativeParameters = isset($narratives['NarrativeRenderer']['parameters']) ? $narratives['NarrativeRenderer']['parameters'] : [];
                        $params = $this->mergeJourneyParams($params, $narrativesParameters);
                        $params = $this->mergeJourneyParams($params, $narrativeParameters);
                        $acts = $narratives['NarrativeRenderer']['acts'];
                        $narratives['NarrativeRenderer']['acts'] = $this->propagateParams($acts, $params);
                        return $narratives['NarrativeRenderer']['acts'][0]['chapter']['renderings'][0]['rendering']['visualElements'];
                    }
                }
            }
        }
